...
using System.Data;
using Oruk.MultiValidation.Data.Entities;
using System.Linq;
...
namespace Oruk.MultiValidation.Data
{
    public class Db
    {
        ...
        private string ConnectionString { get => ConfigurationManager.ConnectionStrings[ConnectionStringName].ConnectionString; }
        ...
        public void UpsertFeed(Feed feed)
        {
            ...
            var fields = new[] { "url", "label", "service_path_override" }.Concat(updateFields).ToArray();
