...
class Navbar extends React.Component {
    ...
    render() {
        return (
            <nav className="navbar navbar-expand-lg navbar-light bg-light backgroundImage" style={{ backgroundImage: `url(/images/background/background${this.state.n}.png)` }} >
                <a id="homeButton" className="mb-0 d-flex align-items-center" style={{ textDecoration: 'none', color: '#212529' }}
                    ...
                    <h4 className="mb-0">Service Finder</h4>
                </a>
                <button className="navbar-toggler btn btn-secondary menu-button" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
